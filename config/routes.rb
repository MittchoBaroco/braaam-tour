Rails.application.routes.draw do
  ...
  put   'admin/tours/highlight/:id',      to: 'admin/tours#highlight', as: "admin_highlight_tour"
  patch 'admin/tours/highlight/:id',      to: 'admin/tours#highlight'
  put   'admin/tours/remove_highlight/:id',      to: 'admin/tours#remove_highlight', as: "admin_remove_highlight_tour"
  patch 'admin/tours/remove_highlight/:id',      to: 'admin/tours#remove_highlight'
  root to: "tours#index"
end
