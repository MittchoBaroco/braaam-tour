class Admin::CommentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_comment.save
        format.html { redirect_to admin_comment_path(@admin_comment),
                      notice: 'Comment was successfully created.' }
        format.json { render :show, status: :created,
                      location:admin_comment_path(@admin_comment) }
        ...
        format.json { render json: @admin_comment.errors,
  ...
  private
    ...
    def admin_comment_params
      ...
      params.fetch(:admin_comment, {}).
              permit(:author_name, :comment_body, :tour_id)
      # params.require(:admin_comment).
      #         permit(:author_name, :comment_body, :tour_id)
  end
end
